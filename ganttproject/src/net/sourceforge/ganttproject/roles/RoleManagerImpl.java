...
public class RoleManagerImpl implements RoleManager {
	...
	public Role getRole(String persistentID) {
		...
		for (int i = 0; i < enabledRoles.length; i++) {
			if (enabledRoles[i].getPersistentID()
					.equalsIgnoreCase(persistentID)) {
	...
	private void createRoleSet() {
		...
		Task.Role[] roleSetFromEnum = Task.Role.values();

		SOFTWARE_DEVELOPMENT_ROLE_SET.clear();

		DEFAULT_ROLE_SET.clear();

		for (Task.Role role : roleSetFromEnum) {

			Integer roleId = Integer.parseInt(role.getPersistentValue());

			if (roleId == 0 || roleId == 1) {

				DEFAULT_ROLE_SET.createRole(
						language.getText(role.getI18rKey()), roleId);

			} else {

				SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(
						language.getText(role.getI18rKey()), roleId);
		...
		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resDeveloper"),
		// 2);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resDocWriter"),
		// 3);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resTester"),
		// 4);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resGraphicDesigner"),
		// 5);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resDocTranslator"),
		// 6);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resPackager"),
		// 7);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resAnalysis"),
		// 8);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resWebDesigner"),
		// 9);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.createRole(language.getText("resNoSpecificRole"),
		// 10);

		// DEFAULT_ROLE_SET.createRole(language.getText("resUndefined"), 0);

		// DEFAULT_ROLE_SET.createRole(language.getText("resProjectManager"),
		// 1);
	...
	private void changeRoleSet() {
		...
		for (Task.Role role : roleSetFromEnum) {
			...
			if (roleId == 0 || roleId == 1) {
				...
				DEFAULT_ROLE_SET.changeRole(
						language.getText(role.getI18rKey()), roleId);

			} else {

				SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(
						language.getText(role.getI18rKey()), roleId);
		...
		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resDeveloper"),
		// 2);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resDocWriter"),
		// 3);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resTester"),
		// 4);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resGraphicDesigner"),
		// 5);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resDocTranslator"),
		// 6);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resPackager"),
		// 7);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resAnalysis"),
		// 8);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resWebDesigner"),
		// 9);

		// SOFTWARE_DEVELOPMENT_ROLE_SET.changeRole(language.getText("resNoSpecificRole"),
		// 10);

		// DEFAULT_ROLE_SET.changeRole(language.getText("resUndefined"), 0);

		// DEFAULT_ROLE_SET.changeRole(language.getText("resProjectManager"),
		// 1);
