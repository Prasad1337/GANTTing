...
public class TaskImpl implements Task {
  ...
  public long[] criticalTimes = new long[4]; //<-- //[EST, EFT, LST, LFT]
...
//      }
  ...
  @Override
  public void setCriticalTimes(long[] critTimes)
  {
	  for(int i=0; i<critTimes.length; i++) this.criticalTimes[i] = critTimes[i];
  }

  @Override
  public long[] getCriticalTimes()
  {
	  return this.criticalTimes;
  }
}
