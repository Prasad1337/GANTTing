...
public class TestResourceAssignments extends TestCase {
    ...
    public void testAutoLevelBasic() {
        TaskManager taskManager = newTaskManager();
        Task t1 = taskManager.createTask();
        Task t2 = taskManager.createTask();
        Task t3 = taskManager.createTask();
        getResourceManager().newHumanResource();
        assertEquals(t1.getStart().getTimeInMillis(),t2.getStart().getTimeInMillis());
        assertEquals(t2.getStart().getTimeInMillis(),t3.getStart().getTimeInMillis());
