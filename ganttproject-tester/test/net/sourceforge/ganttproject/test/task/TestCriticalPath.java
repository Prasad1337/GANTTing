...
public class TestCriticalPath extends TaskTestCase {
    ...
    public void testCriticalTimes()throws Exception{
        TaskManager mgr = getTaskManager();
        Task t1 = createTask();
        Task t2 = createTask();
        Task t3 = createTask();
        ...
        createDependency(t2, t1);
        mgr.getAlgorithmCollection().getCriticalPathAlgorithm().getCriticalTasks();
        long[] t1ct = t1.getCriticalTimes();
        long[] t2ct = {t2.getStart().getTimeInMillis(),t2.getEnd().getTimeInMillis(),t2.getStart().getTimeInMillis(),t2.getEnd().getTimeInMillis()};
        long[] t3ct = {t3.getStart().getTimeInMillis(),t3.getEnd().getTimeInMillis(),t3.getStart().getTimeInMillis(),t3.getEnd().getTimeInMillis()};
        assertArrayEquals(t1ct, t1.getCriticalTimes());
        assertArrayEquals(t2ct, t2.getCriticalTimes());
        assertArrayEquals(t3ct, t3.getCriticalTimes());
    }
